...
//    }
    ...
    protected function browse()
    {
        ...
        print('<h1 align="right">مشتركي النشرة البريدية</h1>');
        print('<span style="margin-right: 10px;width: 200px"><a href="'.box::href("page=send_mail&class=send_mail&event=browse").'"><img src="images/compose_email.png" width="80" title="رسائل النشرة البريدية" /></a></span>');
    ...
    protected function form()
    {
        ...
        print('<tr><td>المدينة:</td><td>');form::add_input('city','text','',$record['city'][0]);print('</td></tr>');
        print('<tr><td>العمل:</td><td>');form::add_input('job','text','',$record['job'][0]);print('</td></tr>');
        print('<tr><td>تاريخ الميلاد:</td><td>');form::add_input('birthdate','text','',$record['birthdate'][0]);print('</td></tr>');
        print('<tr><td>الجنس:</td><td>');form::add_select('gender',$this->gender,$record['gender'][0]);print('</td></tr>');
        //print('<tr><td>brand:</td><td>');form::add_input('brand','text','',$this->get_brand($record['brand'][0]));print('</td></tr>');
        print('<tr><td>الهاتف:</td><td>');form::add_input('phone','text','',$record['phone'][0]);print('</td></tr>');
        //print('<tr><td>IP:</td><td>');form::add_input('ip','text','',$record['ip'][0]);print('</td></tr>');
