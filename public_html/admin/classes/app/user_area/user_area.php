...
class user_area 
{
    ...
    protected function signin()
    {
        if(perm::check_login(array('manager','admin','supervisor'))===false)
        {
            ...
            ?><div id="login_result"></div>
              ...
              <table border="0" style="border-style:solid;border-color:#c6;border-width: 1px;">
              <tr bgcolor="#f0f0f0">
        		  <td valign="top">اسم المستخدم:</td>
              ...
              <tr bgcolor="#f0f0f0">
				<td align="right">الرمز:<font color="#ff0000" face="tahoma">*</font></td>
				<td align="right"><input align="middle" id="code" name="code" maxlength="4" size="20" type="text" onkeyup="this.value=this.value.toUpperCase();this.value=trim(this.value);" /></td>
		  </tr>
		  <tr bgcolor="#f0f0f0">
			  <td align="right">			  
  			...
  			<td align="right">
			  <font face="Verdana" size="2" color="#ffffff"><a href="../image.php" target="ifr" id="change_code">تغيير الرمز</a></font></td>
   		  </tr>
        	 <tr bgcolor="#f0f0f0">
        	  <td valign="top" colspan="2" align="center"><input type="submit" name="submitt" id="submitt" value="دخول" /></td>
        	 </tr>        		 
		</table>
        </form><?            
        }
        ...
        {
            print('<h4>مرحباً في إدارة الموقع</h4><br />');
        }
    }
    protected function form()
    {
        ...
        print('<tr bgcolor="#cccccc"><td>اسم المستخدم:<font color="#ff0000">*</font></td><td>');form::add_input('user','text','',$record[user][0],'disabled="disabled"');print('</td></tr>');
    ...
    protected function login()
    {
		...
		{
			print('<span style="color:#aa0000">عذراً اسم المستخدم أو كلمة المرور غير صحيحين</span>');
        ...
        elseif(empty($this->post['code']) || md5($this->post['code'])!=md5($_SESSION['new_string']))
    	 {
    		print('<span style="color:#aa0000">عذراً هناك خطأ في الرمز</span>');
            print('<script>document.getElementById("change_code").click();_("#code").val("");</script>');
    	 }
		...
		{
			print('<font color="#99CC00">شكراً تم الدخول بنجاح</font>');                
