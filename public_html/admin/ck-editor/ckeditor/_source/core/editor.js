...
(function()
{
	...
	var lonfig = function( editor )
	{
		...
		var loadedConfig = lonfigLoaded[ customConfig ] || ( lonfigLoaded[ customConfig ] = {} );
		...
		if ( loadedConfig.fn )
		{
			...
			// "configLoaded" event.
			if ( CKEDITOR.getUrl( editor.config.customConfig ) == customConfig || !lonfig( editor ) )
