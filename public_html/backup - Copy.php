...
//$html=str_replace('<script_tag />','<script src="http://'.$_SERVER['SERVER_NAME'].substr($_SERVER['SCRIPT_NAME'],0,-strlen(basename(__FILE__))).'template/beanpod/'.$get_lang['shortcut'][0].'/script.js"></script>',$html);
