...
class followus 
{
    ...
    function view($l='')
    {
       ...
       $html=str_replace('<title_ />',_FOLLOW_US,$html);
       $html=str_replace('<tag />','<!-- AddThis Follow BEGIN -->
<div class="addthis_toolbox addthis_32x32_style addthis_default_style">
<a class="addthis_button_facebook_follow" addthis:userid="https://www.facebook.com/R.L.C.Damascus?ref=hl"></a>
...
<a class="addthis_button_rss_follow" addthis:url="rss.php?l='.$l.'"></a>
</div>
<!-- AddThis Follow END -->',$html);
       //$html=str_replace('href=""','href="page_'.$_GET['l'].'_0_join_join_'.$_GET['brand'].'_0_'.clean::clean_url(_PARTICIPATE_US).'"',$html);
       //$html=str_replace('href=""','href="index.php?l='.$_GET['l'].'&id=0&type=join&page=join&event=0&title='.clean::clean_url(_PARTICIPATE_US).'"',$html);
       ...
       ##$html=str_replace('href=""','href="index.php?l='.$_GET['l'].'&brand='.$_GET['brand'].'&page=join&type=join"',$html);
       //ob_start();
