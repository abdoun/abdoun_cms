...
class crypt
{
    ...
    function __construct()
    {
        ...
        $this->key='ebdbf06090f7fcd532551060tfb9a5543';
    }
    public function encrypt($text)
    {        
        return  mcrypt_encrypt(MCRYPT_RIJNDAEL_256, $this->key, $text, MCRYPT_MODE_ECB, $this->iv);
    }
    public function decrypt($crypttext)
    {
		return mcrypt_decrypt(MCRYPT_RIJNDAEL_256, $this->key, $crypttext, MCRYPT_MODE_ECB, $this->iv);	
	}
